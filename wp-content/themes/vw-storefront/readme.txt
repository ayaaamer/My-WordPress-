...
* Done the minor CSS changes.

= 0.2.1 =
* Resolved uncought error.

= 0.2.2 =
* Removed google plus icon from social-icon.php.
* Changed esc_attr instead of esc_html in custom-style.php file.
...
* Done Prefixing.
* Removed logo file.
* Changed shopping bag & user icon  to fontawesome icon. 
...
* Added footer a tag hover in blog page.
* Added icons & hover on a tag in metabox in blog & single blog page.
...
* Done the css of block pattern editor.
* Added hover on logo.
...
= 0.4.3.1 =
* Added function for get started popup.
...
* Added animations for blog page.
...
= 0.5.1 =
* Added woocommerce sale font size option in customizer.
* Updated language folder.

= 0.5.2 =
* Added woocommerce sale border radius option in customizer.
* Updated language folder.
...
* Added classes for ibtana template in responsive.
* Updated language folder.
...
= 0.5.8 =
* Added go pro button in featured products and footer section in customizer.
...
* Add footer background image option in customizer.
* Add option for date, author & comment count in grid layout.
...
* Added button text option in slider settings. 
...
= 0.7.9 = 
* Resolved css for add to cart button in product section.
* Resolved css error in block pattern.

= 0.8 = 
* Resolved slider content css issue.
* Resolved css issue for single product view cart button.

= 0.8.1 =
* Added category and search widgets for preview.
* Added phone, mail, location, myaccount, cart icon setting in customizer.
* Update pot file. 
...
* Resolved css error for cart page in mobile media.
...
= 0.9.1 =
* Resolved css error for add to cart button.
* Resolved css error for calender.
...
* Resolved translation issue in customizer.php file.
...
VW Storefront WordPress Theme, Copyright 2020 VWThemes
VW Storefront is distributed under the terms of the GNU GPL.
...
* Abril+Fatface *
* Source : https://fonts.google.com/specimen/Abril+Fatface?query=Abril+Fatface
...
Slider Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1059478 
...
Product Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/720649

Product Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/963585

Product Image,
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1124415

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-storefront/
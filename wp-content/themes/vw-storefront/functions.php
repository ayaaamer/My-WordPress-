...
function vw_storefront_activation_notice() {
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		...
		echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/storefront-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-storefront' ) .'</a></span>';
		echo '<span class="bundle-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wp-theme-bundle' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'THEME BUNDLE', 'vw-storefront' ) .'</a></span>';
		echo '</div>';
}
...
define('VW_STOREFRONT_FREE_THEME_DOC',__('https://preview.vwthemesdemo.com/docs/free-vw-storefront/','vw-storefront'));
...
define('VW_STOREFRONT_BUY_NOW',__('https://www.vwthemes.com/products/storefront-wordpress-theme','vw-storefront'));
define('VW_STOREFRONT_LIVE_DEMO',__('https://www.vwthemes.net/vw-storefront-pro/','vw-storefront'));
define('VW_STOREFRONT_PRO_DOC',__('https://preview.vwthemesdemo.com/docs/vw-storefront-pro/','vw-storefront'));
...
define('VW_STOREFRONT_CREDIT',__('https://www.vwthemes.com/products/free-storefront-wordpress-theme','vw-storefront'));
define('VW_STOREFRONT_THEME_BUNDLE_BUY_NOW',__('https://www.vwthemes.com/products/wp-theme-bundle','vw-storefront'));
define('VW_STOREFRONT_THEME_BUNDLE_DOC',__('https://preview.vwthemesdemo.com/docs/theme-bundle/','vw-storefront'));
...
function vw_storefront_blog_post_featured_image_dimension(){
	if(get_theme_mod('vw_storefront_blog_post_featured_image_dimension') == 'custom' ) {
		return true;
	}
	return false;
}
...
if (!function_exists('vw_storefront_edit_link')) :

    function vw_storefront_edit_link($view = 'default')
    {
        global $post;
            edit_post_link(
                sprintf(
                    ...
                    /* translators: %s: Name of current post. Only visible to screen readers */
                        __('Edit <span class="screen-reader-text">%s</span>', 'vw-storefront'),
                        array(
                            'span' => array(
                                'class' => array(),
                            ),

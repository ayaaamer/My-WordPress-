...
(function($) {
    ...
    aster_storefront_section_lists.forEach(aster_storefront_homepage_scroll_preview);

    function aster_storefront_homepage_scroll_preview(item, index) {
        ...
        wp.customize.bind('preview-ready', function() {
            ...
            wp.customize.preview.bind(item, function(data) {
                ...
                if (true === data.expanded) {
                    $('html, body').animate({
                        'scrollTop': $('#aster_storefront_' + item + '_section').position().top
                    });
                }
            });
...
(function($) {
    wp.customize('aster_storefront_website_layout', function(value) {
...
(function($) {
    wp.customize('aster_storefront_layout_width_margin', function(value) {
        value.bind(function(newval) {
...
( function( $ ) {
    wp.customize( 'aster_storefront_sidebar_width', function( value ) {
        value.bind( function( newval ) {
...
(function($) {
    wp.customize('aster_storefront_site_logo_width', function(value) {
        value.bind(function(newval) {
